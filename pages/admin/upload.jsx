  ...
  return (
    <div className=' w-full items-center mt-12 md:mt-24 justify-center flex flex-col'>
      <div className='w-full max-w-7xl'>
        <div className=''>
          <section className='relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>
            <svg
