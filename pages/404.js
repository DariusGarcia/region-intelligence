      ...
      <div className='bg-white'>
        <main className='mx-auto w-full max-w-7xl px-6 pb-16 pt-10 lg:px-8'>
          <div className='mx-auto max-w-2xl text-center'>
            <p className='text-2xl font-semibold leading-8 text-blue-600'>
              404
            </p>
          ...
          <div className='mx-auto mt-16 flow-root max-w-lg sm:mt-20'>
            ...
            <ul
              ...
              {links.map((link, linkIdx) => (
                <li
                  key={linkIdx}
                  className='relative flex gap-x-6 py-6 hover:bg-stone-50 transition ease-out p-2 rounded-md'>
            ...
            <div className='mt-10 flex justify-center'>
              <Link
                href='/'
                className='text-sm font-semibold leading-6 text-blue-600 hover:text-blue-500 transition ease-out'>
...
const links = [
  ...
  },
  {
    ...
    description:
      'Check out our interactive map for a list of major planning projects in different cities.',
    icon: MapIcon,
  },
  {
    name: 'FAQ',
  ...
  },
  {
    ...
    href: '/contact',
    description:
      'Get in touch with our dedicated support team for any questions or inquiries. Please allow up to 48 hours for a response.',
    icon: RssIcon,
  },
]
// const social = [
