...
export default function SurveyPage() {
  ...
  return (
    <>
      <div className='mb-12 overflow-hidden rounded-lg bg-white'>
        <div className='flex justify-center mt-4 md:mt-12 px-4 py-5 sm:px-6'>
          {/* Step counter */}
        ...
        <main className='flex flex-col md:flex-row justify-around md:mt-0 px-4 py-5 sm:p-6'>
          {/* Step 1 */}
          {currentStep === 0 && (
            <motion.div
