                  ...
                  {tiers.map((tier, tierIdx) => (
                    <div
                      ...
                      <a
                        ...
                        className={classNames(
                          tier.mostPopular
                            ? 'bg-indigo-600 text-white shadow-sm hover:bg-indigo-500 transition ease-out'
                            : 'bg-indigo-600 text-white ring-1 hover:bg-indigo-500 transition ease-out ring-inset ring-indigo-200 hover:ring-indigo-300',
