                ...
                <div className="w-full h-full flex flex-col gap-4">
                  <div className="flex flex-row gap-4 w-full h-full">
                    <div className="flex flex-col">
                      ...
                      <span className="h-12 w-2 rounded-b-md bg-blue-500"></span>
                    </div>
                    <div className="flex flex-col">
                      <span className="h-24 w-2 rounded-t-md bg-gray-200"></span>
                      <span className="h-10 w-2 rounded-b-md bg-blue-500"></span>
                    </div>
                    <div className="flex flex-col">
                    ...
                    <div className="flex flex-col">
                      <span className="h-24 w-2 rounded-t-md bg-gray-200"></span>
                      <span className="h-4 w-2 rounded-b-md bg-blue-500"></span>
                    </div>
                  </div>
                  <div className="w-full h-full flex flex-row gap-4">
                    <div className="flex flex-col w-full h-full">
                      <span className="w-6 bg-gray-200"></span>
                      <span className="w-6 bg-orange-200"></span>
                    </div>
                    <div className="flex flex-col w-full h-full">
                      <span className="w-24 bg-gray-200"></span>
                      <span className="w-24 bg-gray-200"></span>
                    </div>
                  </div>
                </div>
