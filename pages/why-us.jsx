...
export default function WhyUsPage() {
  return (
    <>
      ...
      <div className=''>
        <div className='relative isolate lg:pb-24 overflow-hidden pt-8 '>
          <div className='mx-auto max-w-7xl  pt-6 sm:py-12 z-50 lg:px-8 flex md:flex-row flex-col justify-between'>
            ...
            <div className='flex flex-col mt-24 lg:mt-0 lg:flex-row relative gap-12 lg:gap-4 py-12 bg-black md:p-12 xl:p-24 p-12 w-full lg:rounded-md'>
              ...
              <div className='lg:absolute border right-20 pb-24  bottom-5  flex flex-col gap-4 justify-end  h-max bg-white p-4 rounded-md'>
                <p className='text-lg font-semibold'>Price Trends</p>
                <div className='flex flex-row gap-4'>
                  <span className='h-2 bg-stone-200 w-12 md:w-24 rounded-md  items-center'></span>
                  <span className='h-2 bg-stone-200 w-12 md:w-24 rounded-md  items-center'></span>
                </div>
        ...
        <div className='w-full flex justify-center my-24 lg:my-0 p-4 md:p-12'>
        ...
        <div className='flex flex-col w-full items-center justify-center mb-24'>
              ...
              <div className='bg-gray-300 p-4 md:p-12 w-full h-full md:rounded-md flex flex-col items-center'>
                {/* <div className='flex flex-col gap-6 bg-white p-4 rounded-md'>
                    ...
                    <div className='grid grid-cols-4 gap-4 lg:gap-8 w-full items-center p-2'>
                      ...
                      <p>Buena Park</p>
                      <p>02-24</p>
                      <p className='bg-neutral-400 p-2 w-12 text-xs text-center justify-end items-end text-black'>
                        View
                      </p>
                    </div>
                    <div className='grid grid-cols-4 gap-8 w-full bg-neutral-100 p-2 items-center'>
                      ...
                      <p>Irvine</p>
                      <p>02-24</p>
                      <p className='bg-neutral-800 p-2 w-12 text-xs text-center  text-white'>
                        View
                      </p>
                    </div>
                    <div className='grid grid-cols-4 gap-8 w-full items-center p-2'>
                      ...
                      <p>Los Angeles</p>
                      <p>02-24</p>
                      <p className='bg-neutral-400 p-2 w-12 text-xs text-center  text-black'>
                        View
                      </p>
                    </div>
                  </div> */}
          ...
          <section className='max-w-7xl flex flex-col xl:flex-row p-8 items-center justify-between gap-6 w-full mt-24'>
            ...
            <div className='w-full xl:w-1/2 rounded-md bg-gray-300 flex flex-col lg:flex-row justify-center gap-4 xl:p-12 p-4'>
              ...
              <div className='flex flex-row justify-between w-full bg-white p-4 h-full rounded-lg'>
                {' '}
                ...
                <div className='w-full h-full flex flex-col gap-4'>
                  <div className='flex flex-row gap-4 w-full items-end h-full'>
                    <div className='flex flex-col'>
                      <span className='h-12 w-2 rounded-t-md bg-gray-200 '></span>
                      <span className='h-12 w-2 bg-blue-500 rounded-b-full rounded-full'></span>
                    </div>
                    <div className='flex flex-col'>
                      <span className='h-24 w-2 rounded-t-md bg-gray-200 '></span>
                      <span className='h-10 w-2 bg-blue-500 rounded-b-full rounded-full'></span>
                    </div>
                    <div className='flex flex-col'>
                      <span className='h-16 w-2 rounded-t-md bg-gray-200 '></span>
                      <span className='h-12 w-2 bg-blue-500 rounded-b-full rounded-full'></span>
                    </div>
                    <div className='flex flex-col'>
                      <span className='h-24 w-2 rounded-t-md bg-gray-200 '></span>
                      <span className='h-4 w-2 bg-blue-500  rounded-full'></span>
                    </div>
                  </div>
                  <div className='w-full h-full flex flex-row gap-4'>
                    <div className='flex flex-col w-full h-full gap-2'>
                      <span className='w-6 h-2 bg-gray-200 rounded-full' />
                      <span className='w-6 h-2 bg-orange-400 rounded-full' />
                    </div>
                    <div className='flex flex-col w-full h-full gap-2'>
                      <span className='w-24 h-2 bg-gray-200 rounded-full' />
                      <span className='w-24 h-2 bg-gray-200 rounded-full' />
                    </div>
                  </div>
                </div>
