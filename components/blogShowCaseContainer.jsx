                      ...
                      (
                        ...
                        post.slug && (
                          <div className="">
                            <article
                              key={post._id}
                              className="relative flex flex-col md:py-0 items-center h-full min-h-[500px] justify-center gap-8 lg:flex-row text-white rounded-xl bg-gray-900 p-4 w-full md:min-w-[250px] "
                            >
                                ...
                                <div className="group relative min-h-[30rem] md:min-h-none flex flex-col items-center justify-center">
                                  <ul className='flex flex-row flex-wrap justify-start w-full items-center gap-4 mb-4'>
                                    {post.categories.map((category) => (
                                        <li className='bg-blue-600 font-semibold p-2 rounded-full text-sm'>{category}</li>
                                    ))}
                                  </ul>
                                  <img
