          ...
          <div className='pointer-events-auto ml-auto max-w-4xl flex flex-col md:h-[20vh] bg-blue-600 justify-center border border-blue-500 rounded-xl p-6 shadow-lg ring-1 ring-gray-900/10'>
            ...
            <div className='mt-4 flex items-center gap-x-5'>
              <button
                ...
                className='rounded-md bg-gray-200 hover:bg-white px-3 py-2 text-sm font-semibold text-black shadow-sm transition ease-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900'>
                Accept all
              </button>
              <button
                type='button'
