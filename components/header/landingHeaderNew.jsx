...
export default function landingHeaderNew() {
  return (
    <div className='my-12 lg:mt-12 lg:mb-24 flex flex-col items-center lg:px-0'>
      <AnimatePresence>
        {' '}
        <div className='p-4'>
        ...
        <section className='hidden lg:block max-w-7xl mt-12 h-full'>
          <Image
            src='landingHeader/indexDashboard.svg'
            alt='dashboard'
            height={200}
            width={200}
          ...
          {/* <m.div className='h-full grid grid-cols-7 bg-gray-50 rounded-lg'>
            ...
            <m.div
              ...
              <m.div
                ...
                <h3 className='text-md font-semibold'>Latest Developments</h3>
              </m.div>
              <m.div
                variants={staggeredCardVariants}
                custom={1}
        ...
        <section className='lg:hidden mt-12'>
          <img src='/landingHeader/mainChart.svg' alt='chart' />
        </section>
        <section className='mt-24 mb-12 flex flex-col gap-24 md:gap-0 md:flex-row items-center justify-between w-full max-w-7xl p-4'>
          <div className='md:w-1/2 w-full p-4'>
            <p className='mb-8 text-lg md:text-2xl leading-9'>
        ...
        <section className='flex flex-col items-center justify-center w-full'>
          <div className='mt-24 w-full flex flex-col items-center max-w-7xl'>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center gap-12 mt-12 w-full '>
              <div className='bg-gray-300 md:w-1/2 p-4 py-12 rounded-md flex items-center justify-center md:p-12'>
        ...
        <section className='flex flex-col justify-center items-center gap-6 w-full mt-12 md:mt-24'>
          <div className='max-w-7xl flex flex-col md:flex-row justify-between items-center gap-6 w-full mt-24'>
            ...
            <div className='py-12 bg-gray-300 md:w-1/2 p-4 rounded-md flex items-center justify-center md:p-12'>
