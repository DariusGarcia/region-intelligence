    ...
    <div className='my-12 lg:my-24 flex flex-col items-center px-2 lg:px-0'>
      <AnimatePresence>
        ...
        <section className='hidden lg:block max-w-7xl mt-24 h-full'>
          <m.div className='h-full grid grid-cols-5 bg-gray-50 rounded-lg'>
            <m.div
              key='card'
              initial='hidden'
              whileInView='visible'
            ...
            <m.div
              ...
              whileInView='visible'
              viewport={{ once: true, amount: 0.2 }}
              className='h-full pl-12 col-span-3 p-4 bg-white'>
              <m.div
                ...
                <section className='grid grid-cols-2 mt-16  '>
                  ...
                  <article className=''>
                    <h4 className='font-semibold mb-4'>Land Comparables</h4>
